<?php 
	function createUser($fname,$username,$password,$email){
		...
		$create_user_query = 'INSERT INTO tbl_user(first_name,user_name,user_pass,user_email)';
...
include('connect.php');
		...
		$update_user_query = 'UPDATE tbl_user SET first_name=:fname, user_name=:username, user_pass=:password, user_email=:email WHERE user_id = :id';
